...
class ClientRegistrationEndpoint:
    ...
    def __init__(self, server=None, claim_classes=None):
        self.server = server
        self.claims_classes = claim_classes or [ClientMetadataClaims]
    ...
    def extract_client_metadata(self, request):
        ...
        for claims_class in self.claims_classes:
            ...
            claims = claims_class(json_data, {}, options, self.get_server_metadata())
            try:
                claims.validate()
