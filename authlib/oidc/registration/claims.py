...
class ClientMetadataClaims(BaseClaims):
    ...
    def validate_token_endpoint_auth_signing_alg(self):
        ...
        """
        token_endpoint_auth_signing_alg = self.get("token_endpoint_auth_signing_alg")
    ...
    def validate_application_type(self):
        ...
        """
        application_type = self.get("application_type")
    ...
    def validate_sector_identifier_uri(self):
        ...
        """
        if sector_identifier_uri := self.get("sector_identifier_uri"):
            self._validate_uri("sector_identifier_uri", sector_identifier_uri)
    ...
    def validate_id_token_signed_response_alg(self):
        ...
        [OpenID.Discovery].
        """
        id_token_signed_response_alg = self.get("id_token_signed_response_alg")
    ...
    def validate_id_token_encrypted_response_alg(self):
        ...
        """
        id_token_encrypted_response_alg = self.get("id_token_encrypted_response_alg")
    ...
    def validate_id_token_encrypted_response_enc(self):
        ...
        """
        id_token_encrypted_response_enc = self.get("id_token_encrypted_response_enc")
    ...
    def validate_userinfo_signed_response_alg(self):
        ...
        content-type.
        """
        userinfo_signed_response_alg = self.get("userinfo_signed_response_alg")
    ...
    def validate_userinfo_encrypted_response_alg(self):
        ...
        """
        userinfo_encrypted_response_alg = self.get("userinfo_encrypted_response_alg")
    ...
    def validate_userinfo_encrypted_response_enc(self):
        ...
        MUST also be provided.
        """
        userinfo_encrypted_response_enc = self.get("userinfo_encrypted_response_enc")
    ...
    def validate_default_max_age(self):
        ...
        """
        default_max_age = self.get("default_max_age")
    ...
    def validate_require_auth_time(self):
        ...
        """
        require_auth_time = self.get("require_auth_time")
    ...
    def validate_default_acr_values(self):
        ...
        """
        default_acr_values = self.get("default_acr_values")
    ...
    def validate_initiate_login_uri(self):
        ...
        parameter.
        """
        if initiate_login_uri := self.get("initiate_login_uri"):
            self._validate_uri("initiate_login_uri", initiate_login_uri)
    ...
    def validate_request_object_signing_alg(self):
        ...
        """
        request_object_signing_alg = self.get("request_object_signing_alg")
    ...
    def validate_request_object_encryption_alg(self):
        ...
        """
        request_object_encryption_alg = self.get("request_object_encryption_alg")
    ...
    def validate_request_object_encryption_enc(self):
        ...
        also be provided.
        """
        request_object_encryption_enc = self.get("request_object_encryption_enc")
    ...
    def validate_request_uris(self):
        ...
        """
        for uri in self.get("request_uris", []):
            self._validate_uri("request_uris", uri)
