...
def test_ecdh_1pu_key_agreement_computation_appx_a():
...
def test_ecdh_1pu_key_agreement_computation_appx_b():
    ...
    assert (
        urlsafe_b64encode(ciphertext) == b"Az2IWsISEMDJvyc5XRL-3-d-RgNBOGolCsxFFoUXFYw"
    )
...
def test_ecdh_1pu_jwe_in_direct_key_agreement_mode():
...
def test_ecdh_1pu_jwe_in_key_agreement_with_key_wrapping_mode():
    jwe = JsonWebEncryption()
    alice_key = {
        "kty": "EC",
        "crv": "P-256",
...
def test_ecdh_1pu_jwe_with_okp_keys_in_direct_key_agreement_mode():
    jwe = JsonWebEncryption()
    alice_key = OKPKey.generate_key("X25519", is_private=True)
    bob_key = OKPKey.generate_key("X25519", is_private=True)
...
def test_ecdh_1pu_jwe_with_okp_keys_in_key_agreement_with_key_wrapping_mode():
    jwe = JsonWebEncryption()
    alice_key = OKPKey.generate_key("X25519", is_private=True)
    bob_key = OKPKey.generate_key("X25519", is_private=True)
...
def test_ecdh_1pu_encryption_with_json_serialization():
    jwe = JsonWebEncryption()
...
def test_ecdh_1pu_decryption_with_json_serialization():
    jwe = JsonWebEncryption()
...
def test_ecdh_1pu_jwe_with_json_serialization_when_kid_is_specified():
    jwe = JsonWebEncryption()
...
def test_ecdh_1pu_jwe_with_json_serialization_for_single_recipient():
    jwe = JsonWebEncryption()
...
def test_ecdh_1pu_encryption_with_public_sender_key_fails():
    jwe = JsonWebEncryption()
...
def test_ecdh_1pu_decryption_with_public_recipient_key_fails():
    jwe = JsonWebEncryption()
    protected = {"alg": "ECDH-1PU", "enc": "A256GCM"}
...
def test_ecdh_1pu_encryption_fails_if_key_types_are_different():
    jwe = JsonWebEncryption()
    protected = {"alg": "ECDH-1PU", "enc": "A256GCM"}
...
def test_ecdh_1pu_encryption_fails_if_keys_curves_are_different():
    jwe = JsonWebEncryption()
    protected = {"alg": "ECDH-1PU", "enc": "A256GCM"}
...
def test_ecdh_1pu_encryption_fails_if_keys_curve_is_inappropriate():
    jwe = JsonWebEncryption()
    protected = {"alg": "ECDH-1PU", "enc": "A256GCM"}
...
def test_ecdh_1pu_decryption_fails_if_key_matches_to_no_recipient():
    jwe = JsonWebEncryption()
