...
Authorization Server Metadata extension (Section 4)
----------------------------------------------------

RFC9728 defines an optional ``protected_resources`` parameter for authorization
server metadata (:rfc:`8414`). You can validate it using the extension class::
